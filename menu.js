...
const ApplicationsButton = new Lang.Class({
    ...
    _init: function(settings) {
        ...
        this._settings.connect('changed::visible-menus', Lang.bind(this, function() {
            this._createLayout();
        }));
    },
        ...
        if(this._settings.get_enum('visible-menus') == visibleMenus.ALL ||
           this._settings.get_enum('visible-menus') == visibleMenus.SYSTEM_ONLY) {
            ...
            this.rightBox.add(settings.actor, { expand: false,
                                                 x_fill: true, y_fill: false,
                                                 y_align: St.Align.START });
            let tweak = new ShortcutMenuItem(this, _("Tweak Tool"), "gnome-tweak-tool-symbolic", "gnome-tweak-tool");
